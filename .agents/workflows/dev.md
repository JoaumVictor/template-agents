...
3. Após finalizar, crie ou atualize um log em `.agents/history/{{current_date}}_resumo.md` contendo:
   - O que foi feito.
   - Caminho dos arquivos alterados.
4. Delete o arquivo `CURRENT_TASK.md` apenas se todos os itens tiverem sido feitos e a tarefa tenha sido finalizada corretamente.
